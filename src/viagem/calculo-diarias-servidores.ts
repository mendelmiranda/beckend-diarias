...
export default class CalculoDiariasServidores {
  ...
  valorServidoresDentroAP(cargo: string): number {

    const cargoServidores  =  ["TCDAS 07", "TCDAS 06", "TCDAS 05", "TCDAS 04", "TCDAS 03", "AUDITOR", "ANALISTA"];
    //contains analista ou auditor (quando estiverem acompanhando, calcular em cima do valor do conselheiro para fora do estado)
